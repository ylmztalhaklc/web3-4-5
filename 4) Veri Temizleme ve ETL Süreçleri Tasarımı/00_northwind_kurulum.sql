...
--
-- UYUMLULUK:
--   CustomerID → NCHAR(5)  (02_insert_dirty_sample_data.sql uyumu)
--   Customers  → 91 satır  (08_validation_queries.sql uyumu)
...
-- ALFKI, ANATR, ANTON, AROUT, BERGS → RAW_Customers dirty data FK hedefleri
-- VINET → FK bütünlüğü için dahil edildi
-- ============================================================
...
-- RAW_Orders dirty data testlerinde ALFKI, ANATR, ANTON, AROUT, BERGS ve
-- diğer müşterilere ait FK geçerliliği bu satırlarla sağlanır.
-- VINET: 5 sipariş (FK bütünlüğü)
...
PRINT '';
PRINT '✓ Northwind hazır! Sonraki script: 01_create_raw_tables.sql';
GO

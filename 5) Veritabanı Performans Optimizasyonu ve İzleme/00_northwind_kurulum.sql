...
-- CustomerID NCHAR(5) — 09_validation_queries.sql uyumu için standart format
...
('VINET', 5, '2024-07-04', '2024-08-01', '2024-07-15', 1, 32.38, 'Vins et alcools', 'Rue Main', 'Reims', 'Marne', '51000', 'France'),
('VINET', 6, '2024-08-01', '2024-09-01', '2024-08-10', 2, 11.61, 'Vins et alcools', 'Rue Main', 'Reims', 'Marne', '51000', 'France'),
('VINET', 3, '2024-10-03', '2024-11-03', '2024-10-12', 3, 45.13, 'Vins et alcools', 'Rue Main', 'Reims', 'Marne', '51000', 'France'),
('VINET', 8, '2024-01-15', '2024-02-15', '2024-01-25', 1, 22.98, 'Vins et alcools', 'Rue Main', 'Reims', 'Marne', '51000', 'France'),
('VINET', 1, '2024-03-22', '2024-04-22', '2024-04-02', 2, 15.40, 'Vins et alcools', 'Rue Main', 'Reims', 'Marne', '51000', 'France');
GO

-- ALFKI — 6 sipariş
INSERT INTO Orders (CustomerID, EmployeeID, OrderDate, RequiredDate, ShippedDate, ShipVia, Freight, ShipName, ShipAddress, ShipCity, ShipRegion, ShipPostalCode, ShipCountry) VALUES
('ALFKI', 6, '2024-08-25', '2024-09-25', '2024-09-05', 1, 29.46, 'Alfreds', 'Obere Str.', 'Berlin', 'Berlin', '12209', 'Germany'),
('ALFKI', 1, '2024-10-03', '2024-11-03', '2024-10-15', 2, 61.02, 'Alfreds', 'Obere Str.', 'Berlin', 'Berlin', '12209', 'Germany'),
('ALFKI', 4, '2024-10-13', '2024-11-13', '2024-10-25', 3,  2.94, 'Alfreds', 'Obere Str.', 'Berlin', 'Berlin', '12209', 'Germany'),
('ALFKI', 1, '2024-01-15', '2024-02-15', '2024-01-28', 1, 23.60, 'Alfreds', 'Obere Str.', 'Berlin', 'Berlin', '12209', 'Germany'),
('ALFKI', 5, '2024-03-16', '2024-04-16', '2024-03-28', 2, 69.53, 'Alfreds', 'Obere Str.', 'Berlin', 'Berlin', '12209', 'Germany'),
('ALFKI', 3, '2024-04-09', '2024-05-09', '2024-04-21', 3, 40.42, 'Alfreds', 'Obere Str.', 'Berlin', 'Berlin', '12209', 'Germany');
GO

-- ANATR — 4 sipariş
INSERT INTO Orders (CustomerID, EmployeeID, OrderDate, RequiredDate, ShippedDate, ShipVia, Freight, ShipName, ShipAddress, ShipCity, ShipRegion, ShipPostalCode, ShipCountry) VALUES
('ANATR', 3, '2024-09-18', '2024-10-18', '2024-09-30', 1, 43.90, 'Ana Trujillo', 'Avenida Reforma', 'México D.F.', 'DF', '05001', 'Mexico'),
('ANATR', 1, '2024-03-04', '2024-04-04', '2024-03-16', 2,  1.35, 'Ana Trujillo', 'Avenida Reforma', 'México D.F.', 'DF', '05001', 'Mexico'),
('ANATR', 2, '2024-04-22', '2024-05-22', '2024-05-04', 3, 13.97, 'Ana Trujillo', 'Avenida Reforma', 'México D.F.', 'DF', '05001', 'Mexico'),
('ANATR', 6, '2024-06-11', '2024-07-11', '2024-06-23', 1, 39.92, 'Ana Trujillo', 'Avenida Reforma', 'México D.F.', 'DF', '05001', 'Mexico');
GO

-- ANTON — 7 sipariş
INSERT INTO Orders (CustomerID, EmployeeID, OrderDate, RequiredDate, ShippedDate, ShipVia, Freight, ShipName, ShipAddress, ShipCity, ShipRegion, ShipPostalCode, ShipCountry) VALUES
('ANTON', 4, '2024-11-27', '2024-12-27', '2025-01-08', 1, 47.45, 'Antonio Moreno', 'Mataderos', 'México D.F.', 'DF', '05023', 'Mexico'),
('ANTON', 3, '2024-08-01', '2024-09-01', '2024-08-13', 2,  9.21, 'Antonio Moreno', 'Mataderos', 'México D.F.', 'DF', '05023', 'Mexico'),
('ANTON', 6, '2024-11-15', '2024-12-15', '2024-11-27', 3, 10.96, 'Antonio Moreno', 'Mataderos', 'México D.F.', 'DF', '05023', 'Mexico'),
('ANTON', 5, '2024-05-20', '2024-06-20', '2024-06-01', 1, 58.43, 'Antonio Moreno', 'Mataderos', 'México D.F.', 'DF', '05023', 'Mexico'),
('ANTON', 8, '2024-02-28', '2024-03-28', '2024-03-10', 2, 12.75, 'Antonio Moreno', 'Mataderos', 'México D.F.', 'DF', '05023', 'Mexico'),
('ANTON', 1, '2024-07-14', '2024-08-14', '2024-07-26', 3, 48.29, 'Antonio Moreno', 'Mataderos', 'México D.F.', 'DF', '05023', 'Mexico'),
('ANTON', 9, '2024-09-03', '2024-10-03', '2024-09-15', 1, 11.11, 'Antonio Moreno', 'Mataderos', 'México D.F.', 'DF', '05023', 'Mexico');
GO

-- AROUT — 13 sipariş (gösterimdeki ilk 5'i)
INSERT INTO Orders (CustomerID, EmployeeID, OrderDate, RequiredDate, ShippedDate, ShipVia, Freight, ShipName, ShipAddress, ShipCity, ShipRegion, ShipPostalCode, ShipCountry) VALUES
('AROUT', 1, '2024-11-15', '2024-12-15', '2024-11-27', 1,  2.91, 'Around the Horn', '120 Hanbury', 'London', 'London', 'WA1 1DP', 'UK'),
('AROUT', 4, '2024-04-16', '2024-05-16', '2024-04-28', 2, 33.78, 'Around the Horn', '120 Hanbury', 'London', 'London', 'WA1 1DP', 'UK'),
('AROUT', 3, '2024-01-04', '2024-02-04', '2024-01-16', 3, 11.12, 'Around the Horn', '120 Hanbury', 'London', 'London', 'WA1 1DP', 'UK'),
('AROUT', 2, '2024-02-10', '2024-03-10', '2024-02-22', 1, 43.26, 'Around the Horn', '120 Hanbury', 'London', 'London', 'WA1 1DP', 'UK'),
('AROUT', 5, '2024-03-25', '2024-04-25', '2024-04-06', 2, 38.15, 'Around the Horn', '120 Hanbury', 'London', 'London', 'WA1 1DP', 'UK'),
('AROUT', 6, '2024-04-30', '2024-05-30', '2024-05-12', 3, 12.50, 'Around the Horn', '120 Hanbury', 'London', 'London', 'WA1 1DP', 'UK'),
('AROUT', 7, '2024-05-12', '2024-06-12', '2024-05-24', 1, 77.52, 'Around the Horn', '120 Hanbury', 'London', 'London', 'WA1 1DP', 'UK'),
('AROUT', 8, '2024-06-05', '2024-07-05', '2024-06-17', 2, 62.75, 'Around the Horn', '120 Hanbury', 'London', 'London', 'WA1 1DP', 'UK'),
('AROUT', 9, '2024-07-09', '2024-08-09', '2024-07-21', 3, 14.37, 'Around the Horn', '120 Hanbury', 'London', 'London', 'WA1 1DP', 'UK'),
('AROUT', 1, '2024-08-22', '2024-09-22', '2024-09-03', 1, 49.18, 'Around the Horn', '120 Hanbury', 'London', 'London', 'WA1 1DP', 'UK'),
('AROUT', 2, '2024-09-15', '2024-10-15', '2024-09-27', 2, 25.64, 'Around the Horn', '120 Hanbury', 'London', 'London', 'WA1 1DP', 'UK'),
('AROUT', 3, '2024-10-08', '2024-11-08', '2024-10-20', 3, 55.97, 'Around the Horn', '120 Hanbury', 'London', 'London', 'WA1 1DP', 'UK'),
('AROUT', 4, '2024-11-25', '2024-12-25', '2025-01-06', 1, 32.00, 'Around the Horn', '120 Hanbury', 'London', 'London', 'WA1 1DP', 'UK');
GO

-- BERGS — 18 sipariş (ilk 5'i)
INSERT INTO Orders (CustomerID, EmployeeID, OrderDate, RequiredDate, ShippedDate, ShipVia, Freight, ShipName, ShipAddress, ShipCity, ShipRegion, ShipPostalCode, ShipCountry) VALUES
('BERGS', 3, '2024-08-12', '2024-09-12', '2024-08-24', 1, 12.78, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden'),
('BERGS', 5, '2024-09-22', '2024-10-22', '2024-10-04', 2, 24.94, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden'),
('BERGS', 1, '2024-10-07', '2024-11-07', '2024-10-19', 3, 55.28, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden'),
('BERGS', 2, '2024-11-20', '2024-12-20', '2025-01-01', 1, 33.64, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden'),
('BERGS', 4, '2024-12-15', '2025-01-15', '2025-01-27', 2,  9.20, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden'),
('BERGS', 6, '2024-01-08', '2024-02-08', '2024-01-20', 3, 77.08, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden'),
('BERGS', 7, '2024-02-14', '2024-03-14', '2024-02-26', 1, 31.41, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden'),
('BERGS', 8, '2024-03-26', '2024-04-26', '2024-04-07', 2, 56.23, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden'),
('BERGS', 9, '2024-04-30', '2024-05-30', '2024-05-12', 3, 14.35, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden'),
('BERGS', 1, '2024-05-18', '2024-06-18', '2024-05-30', 1, 42.60, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden'),
('BERGS', 3, '2024-06-09', '2024-07-09', '2024-06-21', 2,  8.12, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden'),
('BERGS', 5, '2024-07-25', '2024-08-25', '2024-08-06', 3, 66.37, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden'),
('BERGS', 2, '2024-08-31', '2024-09-30', '2024-09-12', 1, 18.90, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden'),
('BERGS', 4, '2024-09-14', '2024-10-14', '2024-09-26', 2, 27.55, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden'),
('BERGS', 6, '2024-10-28', '2024-11-28', '2024-11-09', 3, 39.74, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden'),
('BERGS', 7, '2024-11-12', '2024-12-12', '2024-11-24', 1,  5.44, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden'),
('BERGS', 8, '2024-12-24', '2025-01-24', '2025-01-05', 2, 81.20, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden'),
('BERGS', 9, '2025-01-07', '2025-02-07', '2025-01-19', 3, 22.33, 'Berglunds', 'Berguvsvägen', 'Luleå', 'Norrbotten', 'S-958 22', 'Sweden');
GO
...
BEGIN
    ...
    SELECT cid,
           ...
           DATEADD(day, 30, DATEADD(day, -(@i % 730), '2025-12-31')),
           DATEADD(day, 10, DATEADD(day, -(@i % 730), '2025-12-31')),
           ((@i % 3) + 1),
           CAST((@i % 200) * 0.5 + 1.0 AS DECIMAL(10,2)),
           'Ship To ' + CAST(cid AS NVARCHAR(10)),
           'Address Line ' + CAST(cid AS NVARCHAR(10)),
           'City',
           'Region',
           '00000',
           'USA'
